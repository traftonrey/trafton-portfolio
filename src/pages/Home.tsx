...
const Home = () => (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
        ...
        <div className="w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-8 text-gray-100">
            ...
            >
                <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-emerald-500 to-indigo-400 bg-clip-text text-transparent">
                    Trafton Reynolds
                </h1>
                <div className="mt-4 text-2xl md:text-3xl text-gray-300">
                    <TypeAnimation
                        sequence={[
